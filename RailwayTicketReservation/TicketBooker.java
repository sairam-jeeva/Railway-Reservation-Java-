...
public class TicketBooker
{
    ...
    static List<Integer> lowerBerthsPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5));//normally 1,2,...21
    static List<Integer> middleBerthsPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5));//normally 1,2,...21
    static List<Integer> upperBerthsPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5));//normally 1,2,...21
    static List<Integer> racPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5));//normally 1,2,...18
    static List<Integer> waitingListPositions = new ArrayList<>(Arrays.asList(1,2,3,4,5));//normally 1,2,...10
